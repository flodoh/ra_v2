...
class ReadabilityAnalyzer(object):
    ...
    def create_benchmark(self, data={}):
        ...
        # ADDED: Schreibt in den Typ dictionary fŸr jede Seite (jede Policy) die entsprechenden Scores in ein neues Attribut "Scores" im Dictionary. Beispiel: Coleman Liau Index float: 8.09906103286
        for site in data:
